...
class Fastssh(fekyou):
    ...
    INSTALL_COMMANDS = [
        "sudo git clone https://github.com/ABDUL174/fastssh.git && cd fastssh && sudo chmod +x fastssh.sh",
        "sudo apt-get install -y sshpass netcat"
    ]
    RUN_COMMANDS = ["cd fastssh && sudo bash fastssh.sh --scan"]
    PROJECT_URL = "https://github.com/ABDUL174/fastssh"


class Howmanypeople(fekyou):
    TITLE = "Howmanypeople"
...
class WirelessAttackTools(fekyousCollection):
