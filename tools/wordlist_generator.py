...
class WlCreator(fekyou):
    ...
    INSTALL_COMMANDS = ["sudo git clone https://github.com/ABDUL174/wlcreator.git"]
    RUN_COMMANDS = [
        "cd wlcreator && sudo gcc -o wlcreator wlcreator.c && ./wlcreator 5"]
    PROJECT_URL = "https://github.com/ABDUL174/wlcreator"


class GoblinWordGenerator(fekyou):
...
class WordlistGeneratorTools(fekyousCollection):
